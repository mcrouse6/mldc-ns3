...
WifiHelper::GetStandard (void) const
{
  return m_standard;
}
...
WifiHelper::EnableLogComponents (void)
{
  ...
  LogComponentEnable ("Antenna", LOG_LEVEL_ALL);
  LogComponentEnable ("IsotropicAntenna", LOG_LEVEL_ALL);
  LogComponentEnable ("OmniAntenna", LOG_LEVEL_ALL);
  LogComponentEnable ("ConeAntenna", LOG_LEVEL_ALL);
  LogComponentEnable ("Measured2DAntenna", LOG_LEVEL_ALL);
