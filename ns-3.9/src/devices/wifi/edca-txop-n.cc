              ...
              if (isAmsdu)
                {
                  ...
                  NS_LOG_DEBUG ("tx unicast A-MSDU (" << count << " packets)");
                  //std::cout << "tx unicast A-MSDU (" << count << " packets)" << std::endl;
                }
            }
          if (NeedRts ())
            {
